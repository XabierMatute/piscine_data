...
#                                                 +#+#+#+#+#+   +#+            #
#    Created: 2025/04/15 12:20:31 by xmatute-          #+#    #+#              #
#    Updated: 2025/04/20 21:11:21 by xmatute-         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
def main():
    if len(sys.argv) != 2:
        print("Usage: python table.py <customer_table.csv>")
        sys.exit(1)
    try:
        create_customer_table(sys.argv[1])
